...
create or replace procedure ej8(codigo varchar2)
is
...
begin
update producto set cantidad_en_stock=cantidad_en_stock-detalle_pedido.pedido;
END ACTUALIZAR;
/
...
values (user+sysdate+cliente.codigo_cliente);
